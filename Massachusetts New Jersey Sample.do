...
test treat_rel_m8 treat_rel_m7 treat_rel_m6 treat_rel_m5 treat_rel_m4 treat_rel_m3 treat_rel_m2
...
twoway ///
    ...
    legend(order(1 "Massachusetts" 2 "New Jersey") pos(6) col(1)) ///
    ytitle("Mean Adult Community College Enrollment") ///
    xtitle("Year") ///
    title("Massachusetts & New Jersey Enrollment Trends") ///
    xline(2023, lpattern(shortdash) lwidth(med)) ///
    name(did_trends, replace)

graph export "did_trends_massachusetts.png", width(2000) replace
